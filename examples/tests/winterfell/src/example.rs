...
impl Air for ExampleAir {
    ...
    fn new(
        ...
        Self {
            context,
            stack_inputs: public_inputs.stack_inputs,
            stack_outputs: public_inputs.stack_outputs,
        }
    }
    ...
    fn get_assertions(&self) -> Vec<Assertion<Felt>> {
        ...
        result.push(Assertion::single(
            2,
            self.last_step(),
            self.stack_outputs[1],
        ));
        result.push(Assertion::single(
            3,
            self.last_step(),
            self.stack_outputs[2],
        ));
        result
    }
    ...
    fn evaluate_transition<E: FieldElement<BaseField = Felt>>(
        ...
        result[2] = (E::ONE - main_current[0])
            * (main_current[3] - main_current[1] - main_current[2])
            - E::ZERO;
        result[3] =
            main_current[0] * (main_current[3] - main_current[1] * main_current[2]) - E::ZERO;
    }
